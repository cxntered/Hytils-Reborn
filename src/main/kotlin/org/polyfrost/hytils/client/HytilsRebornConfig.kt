...
//        icon = "polyui/warning.svg",
    ...
    @Button(
        ...
        category = "General", subcategory = "Maintenance"
    )
    @Suppress("unused")
...
//        icon = "polyui/warning.svg",
        ...
        category = "Game", subcategory = "Height Overlay"
    )
    @Suppress("unused")
